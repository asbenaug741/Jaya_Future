...
@section('container')
    <div class="container my-5" style="max-width: 700px;">
        <h2 class="my-5">Update Internship Information</h2>
        <form action="{{ route('admin.internship.update', $internships->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="company_name" name="company_name"
                    placeholder="Write Company Name" value="{{ $internships->company_name }}">
                <span class="text-danger">
                    @error('company_name')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control" id="location" name="location"
                    placeholder="Write Internship Location" value="{{ $internships->location }}">
                <span class="text-danger">
                    @error('location')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="description" name="description" rows="10" style="min-height: 200px;"
                    placeholder="Internship Description">{{ $internships->description }}</textarea>
                <span class="text-danger">
                    @error('description')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="requirement" name="requirement" rows="10" style="min-height: 200px;"
                    placeholder="Write Internship Requirement">{{ $internships->requirement }}</textarea>
                <span class="text-danger">
                    @error('requirement')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control" id="benefit" name="benefit" rows="10" style="min-height: 200px;"
                    placeholder="Write Internship Benefits">{{ $internships->benefit }}</textarea>
                <span class="text-danger">
                    @error('benefit')
                        {{ $message }}
                    @enderror
            ...
            <div class="mb-4">
                ...
                <img src="{{ Storage::url($internships->company_logo) }}" alt="" style="width: 100px;">
                <span class="text-danger">
                    @error('company_logo')
                        {{ $message }}
                    @enderror
